...
@section('content')
    <div class="container-fluid">
        <h3 class="text-dark mb-4">Update Type</h3>
        <div class="row mb-3">
            <div class="col-lg-4">
                <div class="card mb-3">
                    <div class="card-body text-center shadow"><img class="rounded-circle mb-3 mt-4" src="../assets/img/dogs/police1.jpeg" width="238" height="304" style="border-radius: 0%;">
                        <div class="mb-3"></div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card shadow mb-3">
                            ...
                            <div class="card-body">
                                <form>
                                    <div class="row">
                                        <div class="col">
                                            <div class="mb-3"><label class="form-label" for="first_name"><strong>Type Name</strong></label><input class="form-control" type="text" id="first_name-1" placeholder="John" name="nameType"></div>
                                        </div>
                                        <div class="col">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="mb-3"><label class="form-label" for="email"><strong>Type Email Address</strong></label><input class="form-control" type="email" id="email-1" name="emailType"></div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                        ...
                                        <div class="col">
                                            <div class="mb-3"><label class="form-label" for="last_name"><strong>Possition</strong></label><select class="form-select">
                                                    <optgroup label="please select type">
